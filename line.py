def line():
    ...
    coe_A = float(input("Ingresar el coeficiente A: "))
    coe_B = float (input("Ingresar el coeficiente B: "))
    coe_x1 = float(input("Ingresar el coeficiente X1: "))
    coe_x2 = float(input("Ingresar el coeficiente X2: "))
